...
function updateIndexFile(toolName) {
  ...
  if (arrayMatch) {
    ...
    indexContent = indexContent.replace(arrayPattern, `const toolFactories = [${updatedArrayContent}];`);
  }
...
async function createTool() {
  ...
  const toolDescription = await new Promise((resolve) => {
